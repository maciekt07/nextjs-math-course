...
const ResetPasswordEmailTemplate = Object.assign(
  function ResetPasswordEmailTemplate({ url, name }: ResetPasswordEmailProps) {
  ...
  },
  {
    PreviewProps: {
      name: "John",
      url: "https://nextjs-math-course.vercel.app/auth/reset-password?token=preview-token",
