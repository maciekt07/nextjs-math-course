...
export default function CoursesPageSkeleton() {
  return (
    <div className="max-w-4xl mx-auto pt-0 p-5 flex flex-col gap-6" aria-hidden>
          ...
          <div className="px-4 md:px-5 relative">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="flex-1 min-w-0 relative space-y-2 w-full">
                <Skeleton className="h-7 md:h-8 w-3/4 rounded mt-1 md:mt-0" />
                <Skeleton className="h-3 sm:h-4 w-full rounded" />
                <Skeleton className="h-3 sm:h-4 w-full md:w-5/6 rounded" />
                <Skeleton className="h-3 sm:h-4 w-5/6 rounded md:hidden" />
              </div>
            </div>
          </div>

          <div className="flex flex-col gap-4 flex-1 -mt-3 px-4 md:px-5 relative">
            <div className="flex flex-row gap-6 my-1">
              <Skeleton className="h-4 md:h-5 w-22 rounded" />
              <Skeleton className="h-4 md:h-5 w-21 rounded" />
              <Skeleton className="h-4 md:h-5 w-25 rounded" />
            </div>
